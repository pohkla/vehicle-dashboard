...
/* v14.13.4 FINAL: sub-category slide shows only หมวด / ยอดสุทธิ / ยอดเก็บจริง */
.summary-slide-row .summary-subitem.expense-sub{grid-template-columns:1.15fr 1fr 1fr!important;}
.summary-slide-row .summary-subitem.expense-sub .expense,
.summary-slide-row .summary-subitem.expense-sub .remaining,
.summary-slide-row #pickupExpenseAmount,
.summary-slide-row #pickupRemainingAmount,
