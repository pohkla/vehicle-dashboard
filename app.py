...
APP_VERSION = "v6.6 Money Label + Global Filter Loading"
...
function showLoading(msg='กำลังโหลดข้อมูล...'){box('loadingText').textContent=msg;box('loadingOverlay').classList.add('show')}function hideLoading(){box('loadingOverlay').classList.remove('show')}
